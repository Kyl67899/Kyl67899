...
| Retrieval-Augmented Generation (RAG) Pipeline (Project 5) | Google Colab for experimentation and collaboration LlamaIndex, FAISS, or Chroma for vector-based retrieval | https://youtu.be/WjFtTYO5kzc
| split_and_route() Pipeline (Project 7) | Google Colab for experimentation and collaboration Gemini API and open-source LLMs (Mistral, Phi-2) | 
| Working UI/Command-line Search Layer (Project 8) | Google Colab for experimentation and collaboration, Streamlit or Gradio for optional user interface | 
